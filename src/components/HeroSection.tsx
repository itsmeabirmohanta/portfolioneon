...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen bg-background overflow-x-clip overflow-y-hidden">
      <div className="mx-auto w-full max-w-[1300px] px-4 sm:px-6 md:px-10 lg:px-12 py-6 sm:py-8 md:py-9 lg:py-10">
        {/* Top name */}
        ...
        <div className="relative mt-10 sm:mt-12 md:mt-16 lg:mt-20">
          ...
          <div className="relative z-10 flex flex-col items-center animate-hero-fade-up-slow">
            <h1 className="text-foreground font-black text-[48px] sm:text-[76px] md:text-[116px] lg:text-[154px] xl:text-[170px] leading-[0.88] tracking-[-0.05em] text-center select-none transition-all duration-500 hover:tracking-[-0.045em]">
              Design
            </h1>

            <Starburst className="absolute left-[20%] sm:left-[26%] md:left-[26%] lg:left-[29.5%] top-[20px] sm:top-[60px] md:top-[136px] lg:top-[168px] w-[52px] h-[52px] sm:w-[66px] sm:h-[66px] md:w-[90px] md:h-[90px] lg:w-[106px] lg:h-[106px] z-30 animate-hero-spin-slow transition-transform duration-500 hover:scale-110" />

            <div className="mt-1.5 sm:mt-2 md:mt-1 lg:mt-0 flex items-center gap-1.5 sm:gap-2.5 lg:gap-5">
              <span className="text-foreground font-black text-[48px] sm:text-[76px] md:text-[116px] lg:text-[154px] xl:text-[170px] leading-[0.82] tracking-[-0.05em] select-none">
                &
              </span>
        ...
        {/* Bottom content */}
        <div className="mt-8 sm:mt-10 md:mt-12 lg:mt-16 pb-10 sm:pb-12 md:pb-16 lg:pb-20 animate-hero-fade-up-slow">
          <div className="flex flex-col md:grid md:grid-cols-[minmax(190px,224px)_minmax(300px,1fr)_minmax(210px,260px)] gap-6 sm:gap-8 md:gap-7 lg:gap-12 items-center md:items-end">
            ...
            <div className="flex items-center justify-center w-full md:w-auto">
              <div className="text-center max-w-[560px] px-2 sm:px-4 md:px-0">
                <p className="text-muted-foreground text-[16px] sm:text-[18px] md:text-[21px] lg:text-[27px] leading-[1.4] sm:leading-[1.32] lg:leading-[1.26] tracking-[-0.01em]">
                ...
                <p className="text-muted-foreground text-[16px] sm:text-[18px] md:text-[21px] lg:text-[27px] leading-[1.4] sm:leading-[1.32] lg:leading-[1.26] tracking-[-0.01em] mt-2.5 sm:mt-3 md:mt-3 lg:mt-6">
